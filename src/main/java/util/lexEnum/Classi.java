...
public enum Classi{
    Barbarian(new subClass[] {subClass.Berserker, subClass.Path_of_the_Totem_warrior},3,
            ...
            ,new Skills[] {Skills.Animal_Handling,Skills.Athletics,Skills.Intimidation,Skills.Nature,Skills.Perception,Skills.Survival},2,false),
    ...
    Cleric(new subClass[] {subClass.Knowledge_Domain, subClass.Life_Domain, subClass.Light_Domain,
            ...
            ,new Skills[] {Skills.History,Skills.Insight,Skills.Medicine,Skills.Persuasion,Skills.Religion},2,false),
    Druid(new subClass[] {subClass.Circle_of_the_land, subClass.Circle_of_the_moon},2, new Abilities[] {Abilities.INT,Abilities.WIS},
            new Skills[] {Skills.Arcana,Skills.Animal_Handling,Skills.Insight,Skills.Medicine,Skills.Nature,Skills.Perception,Skills.Religion,Skills.Survival},2,false),
    Fighter(new subClass[] {subClass.Champion, subClass.Battle_master, subClass.Eldritch_knight},1, new Abilities[] {Abilities.STR,Abilities.CON},
            new Skills[] {Skills.Acrobatics,Skills.Athletics,Skills.History,Skills.Insight,Skills.Intimidation,Skills.Perception,Skills.Survival},2,false),
    Monk(new subClass[] {subClass.Way_of_the_open_hand, subClass.Way_of_shadow, subClass.Way_of_the_four_elements },3, new Abilities[] {Abilities.STR,Abilities.DEX,},
            new Skills[] {Skills.Acrobatics,Skills.Animal_Handling,Skills.Athletics,Skills.History,Skills.Insight,Skills.Religion,Skills.Stealth},2,false),
    Paladin(new subClass[] {subClass.Oath_of_devotion, subClass.Oath_of_the_ancients, subClass.Oath_of_vengeance},3, new Abilities[] {Abilities.WIS,Abilities.CHA},
            new Skills[] {Skills.Athletics,Skills.Insight,Skills.Intimidation,Skills.Medicine,Skills.Persuasion,Skills.Religion},2,false),
    Ranger(new subClass[] {subClass.Hunter, subClass.Beast_master},3, new Abilities[] {Abilities.STR,Abilities.DEX},
            new Skills[] {Skills.Animal_Handling,Skills.Athletics,Skills.Insight,Skills.Investigation,Skills.Nature,Skills.Perception, Skills.Stealth,Skills.Survival},3,true),
    Rogue(new subClass[] {subClass.Thief, subClass.Assassin, subClass.Arcane_trickster},3, new Abilities[] {Abilities.DEX,Abilities.INT},
            new Skills[] {Skills.Acrobatics,Skills.Athletics,Skills.Deception,Skills.Insight,Skills.Intimidation,Skills.Investigation,Skills.Perception,Skills.Performance,Skills.Persuasion, Skills.Sleight_of_Hand,Skills.Stealth},4,true),
    Sorcerer(new subClass[] {subClass.Dragonic_bloodline, subClass.Wild_magic},1, new Abilities[] {Abilities.CON,Abilities.CHA},
            new Skills[] {Skills.Arcana,Skills.Deception,Skills.Insight, Skills.Intimidation,Skills.Persuasion, Skills.Religion},2,false),
    Warlock(new subClass[] {subClass.The_fiend, subClass.the_archfey, subClass.The_great_old_one},1, new Abilities[] {Abilities.WIS,Abilities.CHA},
            new Skills[] {Skills.Arcana,Skills.Deception,Skills.History,Skills.Intimidation,Skills.Investigation,Skills.Nature,Skills.Religion},2,false),
    Wizard(new subClass[] {subClass.School_of_abjuration, subClass.School_of_divination, subClass.School_of_enchantment,
            ...
            new Skills[] {Skills.Arcana,Skills.Religion,Skills.History,Skills.Insight,Skills.Investigation,Skills.Medicine},2,false);
    ...
    Classi(subClass[] sub, int subclassLevel, Abilities[] savingThrows,Skills[] skills, int numChoice,boolean hasAdd){
        this.subClasses=sub;
